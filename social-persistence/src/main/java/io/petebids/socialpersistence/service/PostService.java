...
import io.petebids.socialpersistence.model.event.document.LanguageInfo;
...
import io.petebids.socialpersistence.model.event.LanguageDetected;
import io.petebids.socialpersistence.model.event.PostCreated;
import io.petebids.socialpersistence.model.event.ProfanityDetected;
...
public class PostService {
    ...
    public PostDocument findById(String id) {
        logger.info("invoked with {}", id);
        return postRepository.findById(id).get();
    }

    public PostDocument createPost(String content) throws JsonProcessingException, ExecutionException, InterruptedException {
    ...
    public void emitPostCreated (PostDocument postDocument) throws JsonProcessingException, ExecutionException, InterruptedException {
        PostCreated postCreated = new PostCreated(postDocument.getId(), postDocument.getContent());
